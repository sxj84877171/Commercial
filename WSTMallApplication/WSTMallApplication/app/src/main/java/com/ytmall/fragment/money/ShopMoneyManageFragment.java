...
public class ShopMoneyManageFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void bindDataForUIElement() {
        tWidget.setCenterViewText("资金管理");
        ...
        txtMyMoney.setText("店铺金额");
        txtUseMoney.setText("店铺可用金额：¥" + Const.user.shopMoney);
        txtLockMoney.setText("店铺冻结金额：¥" + Const.user.shopLockMoney);
        txtLockMoney.setVisibility(View.GONE);
        txtJinMoney.setText("云堂宝: ￥" + trimString(Const.user.jinMoney));
        txtLockJinMoney.setText("云堂宝冻结金额: ￥" + trimString(Const.user.lockJinMoney));
        txtLockJinMoney.setVisibility(View.GONE);
