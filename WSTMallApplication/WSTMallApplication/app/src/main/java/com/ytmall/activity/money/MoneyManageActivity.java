...
public class MoneyManageActivity extends BaseAct implements View.OnClickListener{
    ...
    private TextView txtDistributMoney,txtLockMoney,txtCloudMoney;
    @Override
    ...
    private void initUI(){
        ...
        txtCloudMoney = (TextView) findViewById(R.id.txtCloudMoney);
        txtUseMoney.setText("可用金额：¥"+Const.user.userMoney);
        txtUseMoney.setVisibility(View.GONE);
        ...
        txtCloudMoney.setText("云堂宝：￥" + Const.user.yinMoney);
