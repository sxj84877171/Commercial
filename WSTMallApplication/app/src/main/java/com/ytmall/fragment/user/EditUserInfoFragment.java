...
public class EditUserInfoFragment extends BaseFragment implements View.OnClickListener, BottomPopWindow.OnMenuSelect {
    ...
    @InjectView(id = R.id.back_score_phone_layout_1)
    private View back_score_phone_layout_1;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.back_score_layout:
                ...
                break;
            case R.id.back_score_phone_layout_1:
                replaceFragment(new RetBackScoreFragment(), true);
                break;
        }
    }
    ...
    protected void bindEvent() {
        ...
        back_score_phone_layout_1.setOnClickListener(this);
    }
