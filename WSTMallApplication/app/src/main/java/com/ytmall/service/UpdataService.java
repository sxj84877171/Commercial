...
public class UpdataService extends Service {
    ...
    private void initDownManager() {
        ...
        // 设置下载后文件存放的位置
        down.setDestinationInExternalPublicDir(DOWNLOADPATH, "member.apk");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        String path = Environment.getExternalStorageDirectory().getAbsolutePath() +DOWNLOADPATH+ "member.apk";
