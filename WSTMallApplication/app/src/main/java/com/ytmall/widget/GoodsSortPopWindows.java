...
public class GoodsSortPopWindows extends PopupWindow {
	private View myView;
	private ListView lv_attrs;
	private AttrsSelectInf attrsSelectInf;
	private TextView tv_done;

	public GoodsSortPopWindows(Context context) {
	...
	private class SortAdapter extends BaseAdapter {
		...
		public int getCount() {
			// TODO Auto-generated method stub
			return SortFiled.getGoodsSortFiled().size();
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			tv_attrs.setText(""+SortFiled.getGoodsSortFiled().get(position));
			Log.e("xxxxxxxx", ""+SortFiled.getGoodsSortFiled().get(position));
