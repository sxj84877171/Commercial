...
public class ShopOrderBean implements Serializable {
    public String totalMoney;//商品总金额
    public String deliverMoney;//运费
    public String userName;//收货人名称
    public String userAddress;//收件人地址
    public String userTel;//收件人电话
    public String userPhone;//收件人手机
    public String createTime;//下单时间
    public String orderunique;//订单唯一流水号
    public String realTotalMoney;//实际订单总金额
    public String pd_money;//余额
